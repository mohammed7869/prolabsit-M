            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 min-h-[500px] rounded-3xl overflow-hidden">
                        ...
                        <StaggerItem className="bg-gray-50 p-8 md:p-10 flex flex-col justify-between border-r border-b border-[#2FA9DC]/10 relative group">
                            <div className="mb-6">
                                <div className="w-14 h-14 border border-[#2FA9DC]/20 rounded-xl flex items-center justify-center mb-6 text-[#2FA9DC] group-hover:scale-110 transition-transform duration-300">
                                    <Eye className="w-7 h-7" />
                                </div>
                                <h3 className="text-xl font-bold text-[#2FA9DC] mb-4">Be Transparent</h3>
                            ...
                            <a href="#" className="flex items-center gap-2 text-[#2FA9DC] font-bold text-sm hover:gap-3 transition-all">
                        ...
                        {/* Col 2: Make Calculated Decisions */}
                         <StaggerItem className="bg-gray-50 p-8 md:p-10 flex flex-col justify-between border-r border-b border-[#2FA9DC]/10 relative group">
                            <div className="mb-6">
                                ...
                                <h3 className="text-xl font-bold text-[#2FA9DC] mb-4">Make Calculated Decisions</h3>
                                <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                        ...
                        <StaggerItem className="bg-gray-50 p-8 md:p-10 flex flex-col justify-between border-r border-b border-[#2FA9DC]/10 relative group">
                            <div className="mb-6">
                                ...
                                <h3 className="text-xl font-bold text-[#2FA9DC] mb-4">Value Each Other</h3>
                                <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                        ...
                        <StaggerItem className="bg-gray-50 p-8 md:p-10 flex flex-col justify-between border-b border-[#2FA9DC]/10 relative overflow-hidden group">
                            <div className="relative z-10">
                                <div className="w-14 h-14 border border-[#2FA9DC]/20 rounded-xl flex items-center justify-center mb-6 text-[#2FA9DC] group-hover:rotate-12 transition-transform duration-300">
                                    <Phone className="w-6 h-6" />
                                </div>
                                <h3 className="text-xl font-bold text-[#2FA9DC] mb-4">24*7 IT Support & Monitoring</h3>
                                <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                                ...
                                <div className="space-y-4 mb-8">
                                    <div>
                                        ...
                                        <p className="text-[#2FA9DC] font-bold">971 42866807</p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-gray-500 font-bold uppercase mb-1">Email us :</p>
                                        <p className="text-[#2FA9DC] font-bold">info@domain.com</p>
                                    </div>
                                </div>
                            </div>

                            <div className="relative z-10">
                                <button className="bg-[#2FA9DC] hover:bg-[#1e7ba8] text-white px-6 py-3 rounded-md font-bold text-sm w-full top-3 flex items-center justify-between group cursor-pointer">
                                    Contact Us
